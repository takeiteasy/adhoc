        ...
        (unless (zerop (length (string-trim '(#\Space #\Tab #\Return) line)))
          (handler-case
            ...
            (adhoc/ad:ad-lex-error (e)
              (adhoc/ad:render-diagnostic out line "ERROR!" (adhoc/ad:ad-error-message e)
                                           (adhoc/ad:ad-error-start e) (adhoc/ad:ad-error-end e)))
            (adhoc/ad:ad-parse-error (e)
              (adhoc/ad:render-diagnostic out line "ERROR!" (adhoc/ad:ad-error-message e)
                                           (adhoc/ad:ad-error-start e) (adhoc/ad:ad-error-end e)))
            (adhoc/interpreter:ad-eval-error (e)
              (adhoc/ad:render-diagnostic out line "ERROR!" (adhoc/interpreter:ad-eval-error-message e)
                                           (or (adhoc/interpreter:ad-eval-error-start e) 0)
                                           (or (adhoc/interpreter:ad-eval-error-end e) (length line))))))))
    (format out "~%")))
